...
CREATE VIEW IF NOT EXISTS final AS SELECT b.id, b.year, b.triples, m.weight FROM batting b JOIN master m ON (m.id=b.id) WHERE triples > 5 AND year=2005 ORDER BY m.weight DESC LIMIT 1;
